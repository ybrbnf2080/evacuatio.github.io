...
- Копируем прямо ссылку на группу, она должна вставится в гугл таблицы как ссылка, меняем шрифт на 10, делаем светлосерый фон
...
- Собрать список русскоязычных групп и их админов для каждой страны в [Google-таблице]() для того, что бы попросить их в дальнейшем заполнить страницу по шаблону-анкете.
